...
#write.csv(cluster_df, "/home/angps/Documents/Thesis/Data/cluster_df.csv")
#### Test for stationarity  ###
#stationary_test = ca.jo(cluster_df, type="trace", K=6, ecdet="none", spec="longrun")
#summary(stationary_test)
...
plot(as.vector(var_model@resids), main="Residuals plot of VAR model", 
  xlab="Index", ylab="Residuals",  ylim = c(-100,100))
```
...
plot(as.vector(var_model@fitted),as.vector(var_model@resids), main="Plot of residuals against fitted values", 
  xlab="Fitted Values", ylab="Residuals", xlim=c(-10,20), ylim = c(-10,20))
dev.copy(jpeg,filename="/home/angps/Documents/Thesis/Report/Images/corr_var_res_fit_plot.jpg");
dev.off ();
```
...
```{r}
plot(as.vector(var_model@resids), main="Residuals plot of VAR model", 
  xlab="Index", ylab="Residuals",  ylim = c(-80,80))
```
...
```{r}
par(mfrow=c(2,2))
plot(as.vector(var_model@resids), main="Residuals plot of Clustering model", 
  xlab="Index", ylab="Residuals")
