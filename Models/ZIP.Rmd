...
legend(1,81,legend=c("Euclidean Distance","Correlation of time series","DTW of time series"), col=c("blue","red","black"),
...
# Adding a legend inside box at the location (2,40) in graph coordinates.
# Note that the order of plots are maintained in the vectors of attributes.
legend(1,-600,legend=c("Euclidean Distance","Correlation of time series","DTW of time series"), col=c("blue","red","black"),
                                   pch=c("o","*","+"),lty=c(1,2,3), ncol=1)
