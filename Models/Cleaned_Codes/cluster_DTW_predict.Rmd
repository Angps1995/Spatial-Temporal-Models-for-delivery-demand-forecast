...
get_clustering_by_dtw_result = function(num_clust, ori_df, train_df, pred_method, p=6, struct="Basic", T1=156, T2=198) {
    "
...
quad_score <- c()
for (i in clusters) {
    res <- get_clustering_by_dtw_result(num_clust=i, ori_df = df_atleast_50cts_endo, train_df = train_small, pred_method='VAR')
    MSE <-c(MSE, res$MSE)
...
quad_score <- c()
for (i in clusters) {
    res <- get_clustering_by_dtw_result(num_clust=i, ori_df = df_atleast_50cts_endo, train_df = train_small, pred_method='STAR')
    MSE <-c(MSE, res$MSE)
    quad_score <- c(quad_score, res$quad_score)
}
```

# Apply on full dataset (VAR) (Try clustering groups 2-12 since using Hierachical clustering)
...
quad_score <- c()
for (i in clusters) {
    res <- get_clustering_by_dtw_result(num_clust=i, ori_df = full_df[1:839,], train_df = train_full, pred_method='VAR')
    MSE <-c(MSE, res$MSE)
    quad_score <- c(quad_score, res$quad_score)
}
...
# Apply on full dataset (STAR) (Try clustering groups 2-12 since using Hierachical clustering)
...
quad_score <- c()
for (i in clusters) {
    res <- get_clustering_by_dtw_result(num_clust=i, ori_df = full_df[1:839,], train_df = train_full, pred_method='STAR')
    MSE <-c(MSE, res$MSE)
    quad_score <- c(quad_score, res$quad_score)
}
plot(clusters, MSE, main="MSE against different number of clusters",cex.main=1.2, cex.lab=1.3)
lines(clusters, MSE)
dev.copy(jpeg,filename="/home/angps/Documents/Thesis/Report/Images/Cluster_DTW_STAR_MSE_plot.jpg");
dev.off ();

plot(clusters, quad_score, main="Quad Score against different number of clusters",cex.main=1.2, cex.lab=1.3)
lines(clusters,quad_score)
dev.copy(jpeg,filename="/home/angps/Documents/Thesis/Report/Images/Cluster_DTW_STAR_quad_plot.jpg");
dev.off ();
```

# Apply on full dataset using recovered data (VAR) (Try clustering groups 2-12 since using Hierachical clustering)
...
quad_score <- c()
for (i in clusters) {
    res <- get_clustering_by_dtw_result(num_clust=i, ori_df = full_df[1:839,], train_df = rec_df, pred_method='VAR')
    MSE <-c(MSE, res$MSE)
    quad_score <- c(quad_score, res$quad_score)
}
plot(clusters, MSE, main="MSE against different number of clusters",cex.main=1.2, cex.lab=1.3)
lines(clusters, MSE)
dev.copy(jpeg,filename="/home/angps/Documents/Thesis/Report/Images/Cluster_rec_DTW_MSE_plot.jpg");
dev.off ();

plot(clusters, quad_score, main="Quad Score against different number of clusters",cex.main=1.2, cex.lab=1.3)
lines(clusters,quad_score)
dev.copy(jpeg,filename="/home/angps/Documents/Thesis/Report/Images/Cluster_rec_DTW_quad_plot.jpg");
dev.off ();
```

# Apply on full dataset using recovered data (STAR) (Try clustering groups 2-12 since using Hierachical clustering)
...
quad_score <- c()
for (i in clusters) {
    res <- get_clustering_by_dtw_result(num_clust=i, ori_df = full_df[1:839,], train_df = rec_df, pred_method='STAR')
    MSE <-c(MSE, res$MSE)
    quad_score <- c(quad_score, res$quad_score)
}
plot(clusters, MSE, main="MSE against different number of clusters",cex.main=1.2, cex.lab=1.3)
lines(clusters, MSE)
dev.copy(jpeg,filename="/home/angps/Documents/Thesis/Report/Images/Cluster_rec_DTW_STAR_MSE_plot.jpg");
dev.off ();

plot(clusters, quad_score, main="Quad Score against different number of clusters",cex.main=1.2, cex.lab=1.3)
lines(clusters,quad_score)
dev.copy(jpeg,filename="/home/angps/Documents/Thesis/Report/Images/Cluster_rec_DTW_STAR_quad_plot.jpg");
dev.off ();
```
