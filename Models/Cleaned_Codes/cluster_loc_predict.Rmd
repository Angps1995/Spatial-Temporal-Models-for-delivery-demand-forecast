...
```{r}
x<-get_clustering_by_loc_result(num_clust=3, loc_df = loc_df, ori_df = full_df[1:839,], train_df = train_full)
get_clustering_by_loc_result(num_clust=6, loc_df = loc_df, ori_df = full_df[1:839,], train_df = train_full)
get_clustering_by_loc_result(num_clust=9, loc_df = loc_df, ori_df = full_df[1:839,], train_df = train_full)
get_clustering_by_loc_result(num_clust=12, loc_df = loc_df, ori_df = full_df[1:839,], train_df = train_full)
```
