...
result <- fit_and_eval_var(diff_small_df, df_atleast_50cts, struct = "Basic", p = 9, T1 = 156, T2 = 198)
...
result <- fit_and_eval_var(diff_full_df, full_df, struct = "Basic", p = 9, T1 = 156, T2 = 198)
error_arr <- result$Errors_array
var_error <- result$VAR_Errors
var_fitted <- result$VAR_Fitted
MSE <- result$MSE
