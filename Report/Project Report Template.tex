...
\subsubsection{Using euclidean distance as the distance metric}

\subsubsection{Using DRW as the distance metric}
...
\textbf{\begin{tabular}[c]{@{}l@{}}3-step forecast (Using K-means \\ on geographical location)\end{tabular}} & 40.43 & 62.18                         &  &  \\ \cline{1-3}
\textbf{\begin{tabular}[c]{@{}l@{}}3-step forecast (Using \\ K-means on time series)\end{tabular}}           & 39.49 & 59.15                         &  &  \\ \cline{1-3}
\end{tabular}
\end{table}
