...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth, height=0.35\textheight]{Images/GLM_resids.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth, height=0.35\textheight]{Images/GLM_resids_vs_fitted.jpg}
    \caption{Residuals against Fitted values for GLM Model}
    \label{fig:Residuals against Fitted values for GLM Model}
\end{figure}
