...
\noindent where $y_i$ represents the predicted demand for location i, C(i) represents the cluster which location i belongs to, $D_C(i)$ represents the total demand (from training set) of the cluster C(i), $x_{ij}$ represents the training set demand at location i at time j. 
