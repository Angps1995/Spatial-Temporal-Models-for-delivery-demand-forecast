...
\textbf{\begin{tabular}[c]{@{}l@{}}Clustering using euclidean\\ distance of latitude/longitude\end{tabular}}              & 60.79               & \textbf{60.60}      & 60.61               & 60.62                \\ \hline
\textbf{\begin{tabular}[c]{@{}l@{}}Clustering using correlation \\ between time series as distance\\ metric\end{tabular}} & 60.62               & 62.52               & 62.61               & \textbf{60.00}       \\ \hline
\textbf{\begin{tabular}[c]{@{}l@{}}Clustering using DTW as\\ distance metric\end{tabular}}                                & 63.17               & \textbf{60.59}      & 61.00               & 60.81                \\ \hline
\end{tabular}
\end{table}
...
\textbf{\begin{tabular}[c]{@{}l@{}}3-step forecast (Using K-means \\ on geographical location)\end{tabular}} & 40.43 & 60.60                        &  &  \\ \cline{1-3}
\textbf{\begin{tabular}[c]{@{}l@{}}3-step forecast (Using \\ K-means on correlation \\ of time series)\end{tabular}}           & 39.49 & \textbf{60.00}                         &  &  \\ \cline{1-3}
\textbf{\begin{tabular}[c]{@{}l@{}}3-step forecast (Using \\ K-means on DTW \\ of time series)\end{tabular}}           & 40.10 & 60.59                         &  &  \\ \cline{1-3}
\end{tabular}
\end{table}
