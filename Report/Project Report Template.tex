...
\textbf{\begin{tabular}[c]{@{}l@{}}3-step forecast (Using K-means \\ on geographical location)\end{tabular}} & 40.31                                                                                              & 61.18                         &  &  \\ \cline{1-3}
\textbf{\begin{tabular}[c]{@{}l@{}}3-step forecast (Using \\ K-means on time series)\end{tabular}}           & 39.67                                                                                              & 60.29                         &  &  \\ \cline{1-3}
\end{tabular}
\end{table}
