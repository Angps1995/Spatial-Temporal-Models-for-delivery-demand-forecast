...
\begin{figure}[H]
    ...
    \caption{Plot of residuals against fitted values for VAR model}
    \label{fig:Plot of residuals against fitted values for VAR model}
\end{figure}

\noindent From the plot of residuals against the fitted values of the VAR model, we observe that although there seem to be a concentration towards 
