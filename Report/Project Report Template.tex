...
One limitation of GLM models is that they are only confined to parameter distributions from the exponential family. Vector Generalised Linear Models (VGLM), on the other hand, provides more flexibility. 
