...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth, height=0.6\textheight]{Images/Cluster_Combi_MSE_plot.jpg}
    \textbf{\caption{Plot of MSE against number of clusters for different distance metrics. We can see that the optimal choice based on MSE would be using the correlation between time series with 6 clusters, giving a MSE of 59.27}}
    \label{fig:Plot of MSE against number of clusters for different distance metrics. We can see that the optimal choice based on MSE would be using the correlation between time series with 6 clusters, giving a MSE of 59.27}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth, height=0.6\textheight]{Images/Cluster_Combi_quad_plot.jpg}
    \textbf{\caption{Plot of Quadratic score against number of clusters for different distance metrics. We can see that the optimal choice based on quadratic score is using correlation between time series with 7 custers, giving a quadratic score of -787.27}}
    \label{fig:Plot of Quadratic score against number of clusters for different distance metrics. We can see that the optimal choice based on quadratic score is using correlation between time series with 7 custers, giving a quadratic score of -787.27}
\end{figure}
%
%\begin{figure}[H]
%    \centering
...
\textbf{3-step approach (geographical location,VAR)}      & 39.46 &                        -19.28 & 60.11            & -786.93                 \\ \hline
\textbf{3-step approach (geographical location,STAR)}      & x &                        -x & x            & -x             \\ \hline
\textbf{3-step approach (correlation of time series,VAR)} & 40.73             &      -18.28                  & 59.27            & -705.43                 \\ \hline
\textbf{3-step approach (correlation of time series,STAR)} & x &      -x                 & x           & -x              \\ \hline
\textbf{3-step approach (DTW of time series,VAR)}         & 37.96             &       -19.69                  & 60.36            & -785.25                 \\ \hline
\textbf{3-step approach (DTW of time series,STAR)}         & x &       -x                  & x          & -x                \\ \hline
\end{tabular}
\textbf{\caption{MSE and Quadratic Score of the different methods used in this paper}}
\end{table}
...
\textbf{3}                  & \textbf{60.11}                                     & 61.97 & 61.49                            \\ \hline
\textbf{4}                  & 62.09                                              & 65.51 & 61.28                            \\ \hline
\textbf{5}                  & 60.28 & 64.31 & 61.00                            \\ \hline
\textbf{6}                  & 63.35 & \textbf{63.95} & 61.40                            \\ \hline
\textbf{7}                  & 61.68 & 65.12 & 60.73                            \\ \hline
\textbf{8}                  & 58.19 & 63.13 & \textbf{60.36}                   \\ \hline
\textbf{9}                  & 63.27 & 64.50 & 60.55                            \\ \hline
\textbf{10}                 & 62.55                                              & 58.48 & 61.37                            \\ \hline
...
\textbf{3}                  & \textbf{-786.93} & 786.66 & -785.45 \\ \hline
\textbf{4}                  & -786.41 & -786.06 & -785.70                            \\ \hline
\textbf{5}                  & -786.44 & -761.14 & -785.75 \\ \hline
\textbf{6}                  & -776.18 & -741.99 & -785.67 \\ \hline
\textbf{7}                  & -776.14 & \textbf{-724.84} & \textbf{-785.88} \\ \hline
\textbf{8}                  & -787.15 & -694.31 & -785.25 \\ \hline
...
\textbf{3}                  & \textbf{60.91}                                     & 64.58 & 60.52                            \\ \hline
\textbf{4}                  & 62.40 & 64.01 & 60.99                            \\ \hline
\textbf{5}                  & 61.14 & 61.35 & 60.34 \\ \hline
\textbf{6}                  & 60.83 & \textbf{64.03} & 61.38 \\ \hline
\textbf{7}                  & 58.95 & 63.86 & 60.83                            \\ \hline
\textbf{8}                  & 63.03                                              & 66.87 & \textbf{59.42}                   \\ \hline
\textbf{9}                  & 62.06 & 67.95 & 59.00                            \\ \hline
\textbf{10}                 & 59.08                                              & 61.87 & 58.73                            \\ \hline
\textbf{11}                 & 61.25                                              & 63.85 & 58.53 \\ \hline
...
\textbf{3}                  & \textbf{-753.94} & -786.15 & -786.97 \\ \hline
\textbf{4}                  & -758.61 & -786.65 & -786.97                            \\ \hline
\textbf{5}                  & -757.77 & -787.25 & -787.09 \\ \hline
\textbf{6}                  & -787.01 & -740.66 & -786.93 \\ \hline
\textbf{7}                  & -760.05 & \textbf{-755.22} & \textbf{-787.00} \\ \hline
\textbf{8}                  & -760.44 & -699.55 & -787.09 \\ \hline
\textbf{9}                  & -752.48 & -746.15 & -787.23 \\ \hline
\textbf{10}                 & -732.82 & -728.37 & -787.25                            \\ \hline
