...
\noindent We will outline the basic theoretical framework for the STAR models, as also described in \cite{KURT20152537}. STAR models can be expressed as : 

\begin{center}
    $\displaystyle y_{i,t} = \phi y_{i,t-1} + \varphi \sum_{j=1}^{k}w_{i,j}^{(s)}y_{j,t-1} + \epsilon_{i,t}$
\end{center}
...
\textbf{STAR}                                                                                                & 39.76                                                                                              & 81.50                         &  &  \\ \cline{1-3}
