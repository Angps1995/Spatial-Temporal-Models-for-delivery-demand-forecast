...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth, height=0.6\textheight]{Images/Cluster_Combi_MSE_plot.jpg}
    \textbf{\caption{Plot of MSE against number of clusters for different distance metrics}}
    \label{fig:Plot of MSE against number of clusters for different distance metrics}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth, height=0.6\textheight]{Images/Cluster_Combi_quad_plot.jpg}
    \textbf{\caption{Plot of Quadratic score against number of clusters for different distance metrics}}
    \label{fig:Plot of Quadratic score against number of clusters for different distance metrics}
\end{figure}
...
\textbf{3-step approach (using geographical location)}      & 39.46 &                        -19.28 & 60.11            & -786.93                 \\ \hline
\textbf{3-step approach (using correlation of time series)} & 40.73             &      -18.28                  & 59.27            & -705.43                 \\ \hline
\textbf{3-step approach (using DTW of time series)}         & 37.96             &       -19.69                  & 60.36            & -785.25                 \\ \hline
\end{tabular}
...
\textbf{2}                  & 69.71                                              & 63.48 & 62.96                            \\ \hline
\textbf{3}                  & \textbf{60.10}                                     & 63.36 & 61.49                            \\ \hline
\textbf{4}                  & 62.09                                              & 64.26 & 61.28                            \\ \hline
\textbf{5}                  & 62.20                                              & 60.43 & 61.00                            \\ \hline
\textbf{6}                  & 62.04                                              & \textbf{59.27} & 61.40                            \\ \hline
\textbf{7}                  & 62.26                                              & 60.95 & 60.73                            \\ \hline
\textbf{8}                  & 63.97                                              & 65.34 & \textbf{60.36}                   \\ \hline
\textbf{9}                  & 64.69                                              & 68.84 & 60.55                            \\ \hline
\textbf{10}                 & 61.09                                              & 64.61 & 61.37                            \\ \hline
\textbf{11}                 & 61.80                                              & 62.83 & 63.44                            \\ \hline
\textbf{12}                 & 64.07                                              & 64.03 & 66.15                            \\ \hline
\end{tabular}
\textbf{\caption{MSE with different cluster size and distance metric}}
\end{table}

\subsection{Quadratic Score for different cluster size and distance metric}
...
\hline
\textbf{Cluster Size} & \textbf{Euclidean Distance} & \textbf{Correlation between time series} & \textbf{DTW Distance} \\ \hline
\textbf{1}                  & -784.87 & -784.87 & -                                \\ \hline
\textbf{2}                  & -785.07 & -786.37 & -785.32 \\ \hline
\textbf{3}                  & \textbf{-786.93} & 786.46 & -785.45 \\ \hline
\textbf{4}                  & -786.41 & -785.75 & -785.70                            \\ \hline
\textbf{5}                  & -776.42 & -749.58 & -785.75 \\ \hline
\textbf{6}                  & -740.16 & -705.43 & -785.67 \\ \hline
\textbf{7}                  & -786.67                                              & \textbf{-787.28} & \textbf{-785.88} \\ \hline
\textbf{8}                  & -741.91 & -625.82 & -785.25 \\ \hline
\textbf{9}                  & -746.62 & -693.53 & -785.45 \\ \hline
\textbf{10}                 & -785.78 & -737.04 & -784.90                            \\ \hline
\textbf{11}                 & -786.82 & -786.50 & -784.61 \\ \hline
\textbf{12}                 & -764.94 & -702.31 & -784.37 \\ \hline
\end{tabular}
\textbf{\caption{Quadratic Score with different cluster size and distance metric}}
\end{table}
